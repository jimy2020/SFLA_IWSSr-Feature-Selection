function Mimplex1 = IWSS_WithReplacementOneColony(Mimplex)
    global var;
    Mimplex1 = struct('SelVar',{},'AvgAcc',{});
    Set(1,:)=Mimplex.SelVar;
   
        [~,IX] = sort(var.Score(Mimplex.SelVar),'descend');
        Set = Set(IX);
        Mimplex1 = Func(Set);
        % fprintf('%f    ', Mimplex1.AvgAcc );
       %  fprintf('%f  \n  ', Mimplex1.AvgAcc );
    clear Set
 end
